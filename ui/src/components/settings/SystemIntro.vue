...
<template>
  <div class="system-intro-container">
    ...
    <p class="system-intro-paragraph">
      <strong>Apboa</strong> 是基于领先的 <strong>AgentScope</strong> 框架打造的新一代智能体开发与管理平台。我们致力于将复杂的AI智能体开发过程变得简单、高效，让您能轻松拥有功能强大的专属数字助手。
    </p>
    ...
    <p class="system-intro-paragraph">
      无论是构建客服助手、创意伙伴还是行业专家，您都无需从零开始。在 Apboa 的赋能下，只需通过简单的配置与拖拽，即可将前沿的AI能力快速转化为解决实际业务问题的智能体，大幅降低技术门槛与开发周期，真正实现智能应用的随需而创、高效落地。
    </p>

    <p class="system-intro-slogan">在 Apboa，轻松开启您的智能体之旅。</p>
  </div>
</template>
