...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/AgentScope-1.0.12-orange.svg" alt="AgentScope" />
...
- [参与贡献](#-参与贡献)
  ...
  - [Pull Request 提交指南](#-pull-request-提交指南)
- [License](#-license)
...
| ![image-20260411140636264](image/image-20260411140636264.png) | ![image-20260411140659383](image/image-20260411140659383.png) |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| ![image-20260411140717467](image/image-20260411140717467.png) | ![image-20260411140733513](image/image-20260411140733513.png) |
| ![image-20260411140754472](image/image-20260411140754472.png) | ![image-20260411140827201](image/image-20260411140827201.png) |
| ![image-20260411140847484](image/image-20260411140847484.png) | ![image-20260411140921656](image/image-20260411140921656.png) |
| ![image-20260411141406956](image/image-20260411141406956.png) | ![image-20260411141421777](image/image-20260411141421777.png) |
| ![image-20260506003900491](image/image-20260506003900491.png) | ![image-20260506004119213](image/image-20260506004119213.png) |
| ![image-20260502194842488](image/image-20260502194842488.png) | ![image-20260502195403150](image/image-20260502195403150.png) |
| ![image-20260411140000801](image/image-20260411140000801.png) | ![image-20260411140006536](image/image-20260411140006536.png) |
| ![image-20260502194942081](image/image-20260502194942081.png) |                                                              |
...
内置功能完备的 Markdown 渲染引擎，开箱即用，同时支持灵活扩展。
...
| 数学公式 | 支持 KaTeX 渲染行内与块级公式 |
| XSS 防护 | 内置 DOMPurify 过滤，防止脚本注入 |
| 容器语法 | 支持 `:::tip` / `:::warning` 等自定义容器 |

## 灵活扩展

**容器扩展自动发现**：在 `extensions/container/` 目录下创建 `xxx-extension.ts` 文件，引擎自动发现并注册。

**渲染器处理器覆盖**：直接修改 `handlers/` 目录下的处理器文件，即可自定义图片、代码块等元素的渲染方式。

> 详细扩展指南请参考平台内的「扩展开发指南」文档。



## 预览

| ![image-20260412165749836](image/image-20260412165749836.png) | ![image-20260412165823512](image/image-20260412165823512.png) |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| ![image-20260412165908454](image/image-20260412165908454.png) | ![image-20260412165929208](image/image-20260412165929208.png) |
| ![image-20260412170001004](image/image-20260412170001004.png) | ![image-20260412170023565](image/image-20260412170023565.png) |
| ![image-20260412170053559](image/image-20260412170053559.png) | ![image-20260412170111978](image/image-20260412170111978.png) |
| ![image-20260425175355711](image/image-20260425175355711.png) | ![image-20260412170211539](image/image-20260412170211539.png) |

# 内置使用手册

| ![image-20260419124239189](image/image-20260419124239189.png) | ![image-20260419124319295](image/image-20260419124319295.png) |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
...
欢迎 Issue、PR、讨论与建议。如果这个项目对你有帮助，请点一个 Star 支持一下！

## Issue 提交指南

在提交 Issue 之前，请先完成以下检查：

- 在 [Issues](../../issues) 中搜索是否已存在相同或类似的问题，避免重复提交
- 确认使用的是最新版本代码，问题可能已在最新提交中修复
- 阅读项目文档，确认是否为配置或使用方式的问题
...
- **复现步骤**：提供最小可复现的操作步骤
- **期望行为**：描述你期望发生的正确行为
- **实际行为**：描述实际发生的情况（含错误日志或截图）
- **环境信息**：操作系统、Java 版本、Node 版本、数据库版本等
- **附加信息**：相关的配置文件、日志输出、截图等
...
1. Fork 本仓库并克隆到本地
2. 从 `master` 分支创建新的功能分支，分支命名建议：`feature/xxx`、`fix/xxx`、`docs/xxx`
3. 确保代码与最新 `master` 分支保持同步

### 代码规范

- 遵循项目已有的代码风格和注释规范
- 提交前确保本地构建通过：后端 `mvn clean install`，前端 `pnpm run build`
...
1. 提交 PR 时，标题应简洁明了地概括变更内容
2. 描述中应说明：
   - **变更内容**：做了什么改动，为什么这样做
   - **关联 Issue**：引用相关的 Issue 编号（如 `Closes #123`）
   - **测试说明**：如何验证本次变更
   - **影响范围**：可能影响的功能模块
3. 保持 PR 粒度适中：一个 PR 只解决一个问题或实现一个功能
4. 确保 CI 流水线全部通过
5. 等待维护者 Code Review，并根据反馈意见及时修改

### Review 流程

- 维护者会在 3-5 个工作日内进行 Review
- 请及时响应 Review 意见，超过 30 天无响应的 PR 可能会被关闭
- 代码合并后将由维护者统一管理发版节奏
...
| Apboa 交流群1（已满）                                        | Apboa 交流群2                                                | Apboa 交流群3                                                |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| ![image-20260508235150666](image/image-20260508235150666.png) | ![image-20260521093906069](image/image-20260521093906069.png) | ![image-20260521093957855](image/image-20260521093957855.png) |
