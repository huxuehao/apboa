...
`failure_source` enum('NONE','RUNTIME_AUTO_DEGRADE') NOT NULL DEFAULT 'NONE' COMMENT '澶辫触鏉ユ簮',
`activation_status_changed_at` datetime NULL DEFAULT NULL COMMENT '杩炴帴鐘舵€佹渶杩戜竴娆″彉鏇存椂闂?,
...
`runtime_fail_threshold` int NOT NULL DEFAULT 3 COMMENT '杩愯鏃惰嚜鍔ㄩ檷绾ц繛缁け璐ラ槇鍊硷紝0 琛ㄧず鍏抽棴',
